      ...
      <div className='flex flex-col md:flex-row gap-16 justify-center items-center'>
        ...
        <ul>
          <li className='flex gap-4 pb-6 relative items-baseline'>
            <div className='before:absolute before:left-[5.5px] before:h-full before:w-[1px] before:bg-gray-600 dark:before:bg-gray-200'>
              <svg height="12" width="12" xmlns="http://www.w3.org/2000/svg" className="bi bi-circle-fill fill-gray-600 dark:fill-gray-200">
                <circle r="6" cx="6" cy="6" />
              </svg>
            </div>
            <div className='text-sm text-gray-700 dark:text-gray-300'>
              <p className='text-black dark:text-white font-semibold pb-1'>Vellore Institute of Technology, Chennai</p>
              <p>B.Tech CSE - Ai&R</p>
              <p>2023 - Present</p>
            </div>
          </li>
          <li className='flex gap-4 pb-6 relative items-baseline'>
            ...
            <div className='text-sm text-gray-700 dark:text-gray-300'>
              <p className='text-black dark:text-white font-semibold pb-1'>Resonance, Hyderabad</p>
              <p>MPC</p>
              <p>2021 - 2023</p>
            </div>
          </li>
          <li className='flex gap-4 pb-6 relative items-baseline'>
            ...
            <div className='text-sm text-gray-700 dark:text-gray-300'>
              <p className='text-black dark:text-white font-semibold pb-1'>Delhi Public School, Warangal</p>
              <p>CBSE</p>
              <p>2014 - 2021</p>
            </div>
          </li>
