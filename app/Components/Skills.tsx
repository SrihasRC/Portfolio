      ...
      <div className="w-full md:w-4/5 xl:w-full mx-auto flex flex-col items-center md:flex-row gap-8 justify-center flex-wrap">
        ...
        <div className="w-90 md:min-h-81 md:w-100 xl:w-120 px-8 md:px-4 xl:px-8 py-4 border border-gray-200 dark:border-black hover:-translate-y-2 transition duration-250 shadow-md rounded-xl bg-[#f6f6f6] dark:bg-[#202020]">
          ...
          <div className='flex flex-wrap justify-center gap-4 w-[90%] mx-auto'>
            ...
            <div className='hover:scale-110 dark:bg-darkBg dark:border-black dark:text-gray-200 cursor-pointer transition duration-200 flex justify-center items-center gap-1 pl-2 pr-4 py-2 bg-white border border-gray-300 w-fit rounded-xl'>
              <Image src={assets.next} alt=''  className='w-7 dark:invert'/>
              <p>NextJS</p>
            </div>
          </div>
        </div>
        ...
        <div className="w-90 md:min-h-81 md:w-100 xl:w-120 px-8 md:px-4 xl:px-8 py-4 h-75 border border-gray-200 dark:border-black hover:-translate-y-2 transition duration-250 shadow-md rounded-xl bg-[#f6f6f6] dark:bg-[#202020]">
          ...
          <div className='flex flex-wrap justify-center gap-4 w-[90%] mx-auto'>
            ...
            <div className='hover:scale-110 dark:bg-darkBg dark:border-black dark:text-gray-200 cursor-pointer transition duration-200 flex justify-center items-center py-1 pl-3 gap-1 pr-4 bg-white border border-gray-300 w-fit rounded-xl'>
              <Image src={assets.express} alt=''  className='w-8 dark:invert'/>
              <p>Express</p>
            </div>
            <div className='hover:scale-110 dark:bg-darkBg dark:border-black dark:text-gray-200 cursor-pointer transition duration-200 flex justify-center items-center py-1 pl-3 gap-1 pr-4 bg-white border border-gray-300 w-fit rounded-xl'>
            ...
            <div className='hover:scale-110 dark:bg-darkBg dark:border-black dark:text-gray-200 cursor-pointer transition duration-200 flex justify-center items-center py-1 pl-1 gap-1 pr-4 bg-white border border-gray-300 w-fit rounded-xl'>
              <Image src={assets.supabase} alt=''  className='w-10'/>
              <p>Supabase</p>
            </div>
            <div className='hover:scale-110 dark:bg-darkBg dark:border-black dark:text-gray-200 cursor-pointer transition duration-200 flex justify-center items-center pl-2 py-2 gap-1 pr-4 bg-white border border-gray-300 w-fit rounded-xl'>
        ...
        <div className="w-90 md:min-h-81 md:w-100 xl:w-120 px-8 md:px-4 xl:px-8 py-4 h-75 rounded-xl border border-gray-200 dark:border-black hover:-translate-y-2 transition duration-250 shadow-md bg-[#f6f6f6] dark:bg-[#202020]">
          ...
          <div className='flex flex-wrap justify-center gap-4 w-[90%] mx-auto'>
            ...
            <div className='hover:scale-110 dark:bg-darkBg dark:border-black dark:text-gray-200 cursor-pointer transition duration-200 flex justify-center items-center py-2 gap-1 pl-2 pr-4 bg-white border border-gray-300 w-fit rounded-xl'>
              <Image src={assets.github_mark} alt=''  className='w-8 dark:invert'/>
              <p>Github</p>
            </div>
            <div className='hover:scale-110 dark:bg-darkBg dark:border-black dark:text-gray-200 cursor-pointer transition duration-200 flex justify-center items-center gap-1 pl-2 py-2 pr-4 bg-white border border-gray-300 w-fit rounded-xl'>
